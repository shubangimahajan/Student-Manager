...
#    Dec 28, 2018 10:00:58 AM IST  platform: Windows NT
...
import pwdreset_support

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = tk.Tk()
    pwdreset_support.set_Tk_var()
    top = Toplevel1 (root)
    pwdreset_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(root, *args, **kwargs):
    ...
    pwdreset_support.set_Tk_var()
    top = Toplevel1 (w)
    pwdreset_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.TCombobox1.place(relx=0.4, rely=0.222, relheight=0.047
                , relwidth=0.238)
        self.value_list = [10,20,30,40,]
        self.TCombobox1.configure(values=self.value_list)
        self.TCombobox1.configure(textvariable=pwdreset_support.combobox)
        ...
        self.Button1.place(relx=0.5, rely=0.489, height=24, width=42)
        ...
        self.Entry1.place(relx=0.4, rely=0.111,height=20, relwidth=0.273)
        ...
        self.Entry2.place(relx=0.4, rely=0.333,height=20, relwidth=0.273)
        ...
        self.Entry3.place(relx=0.4, rely=0.667,height=20, relwidth=0.273)
        ...
        self.Button2.place(relx=0.5, rely=0.822, height=24, width=34)
